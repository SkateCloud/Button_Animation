...
@IBDesignable class SubmitButton: UIButton {
    ...
    @IBInspectable var checkLineWidth: CGFloat = 8  //对号的宽度
    @IBInspectable var progressBorderWidth: CGFloat = 5.0  //进度线的宽度
    ...
    private func startLoadingAnimation() {
        ...
        group.duration = 1//0.5
        group.timingFunction = CAMediaTimingFunction(name: kCAMediaTimingFunctionEaseInEaseOut)
        group.beginTime = CACurrentMediaTime() + 0.2//0.1
        ...
        // frame
        let sizeAnimation = CABasicAnimation(keyPath: "frame")//CABasicAnimation(keyPath: "frame")
        let x = (self.layer.bounds.width - self.layer.bounds.height) / 2
        ...
        // bounds
        let boundsAnimation = CABasicAnimation(keyPath: "bounds")//CABasicAnimation(keyPath: "bounds")
        boundsAnimation.toValue = NSValue(cgRect: self.loadingBounds)
        
        
        // cornerRadius
        let cornerRadiusAnimation = CABasicAnimation(keyPath: "cornerRadius")//CABasicAnimation(keyPath: "cornerRadius")
        cornerRadiusAnimation.toValue = self.loadingCornerRadius
        
        // backgroundColor
        let backgroundColorAnimation = CABasicAnimation(keyPath: "backgroundColor")//CABasicAnimation(keyPath: "backgroundColor")
        backgroundColorAnimation.toValue = UIColor.clear.cgColor
        
        // borderColor
        let borderColorAnimation = CABasicAnimation(keyPath: "borderColor")//CABasicAnimation(keyPath: "borderColor")
    ...
    private func checkAnimation() {
        let pathAnimation = CASpringAnimation(keyPath: "strokeEnd")//CABasicAnimation(keyPath: "strokeEnd")
